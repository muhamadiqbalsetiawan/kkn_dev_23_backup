...
const SuccessModal = ({ isOpen, onClose, onRefresh, isMessage }) => {
    ...
    >
      <div className="bg-white p-6 rounded shadow-lg text-center">
        <div className="w-full">
          <CheckCircleIcon className="mx-auto w-24 text text-green-600" />
        </div>
        <h2 className="text-xl font-bold  mb-2">File Upload Berhasil</h2>
