            ...
            <div className="px-6 pb-5 w-auto">
              ...
              <div className="px-3 py-8 md:p-6 bg-white shadow-lg rounded-xl w-full">
                <div>
                  ...
                  <div className="grid md:grid-cols-2 xl:grid-cols-3 font-medium px-4 gap-6 text-gray-900">
                    {tablesList && tablesList.length > 0 ? (
                      tablesList.map((item, i) => (
                        <div
                          className="bg-white rounded-xl shadow-md flex flex-col justify-between border-2 border-iconHoverColor"
                        ...
                        >
                          ...
                          <div className="flex flex-row justify-between">
                            ...
                            <div className="w-1/3 text-center bg-iconHoverColor py-2 rounded-ee-lg text-white hover:bg-iconHoverColor/90">
                              <button>
                                <Link
                                  href={`/dosen/detailKelompok/${item.kelompok_id}`}
                                >
