                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 xl:grid-cols-3 font-medium px-4 gap-6">
                    {tables && tables.length > 0 ? (
                      tables.map((item, i) => (
                        <div
                          className="bg-white rounded-xl shadow-md flex flex-col justify-between border-2 border-thirdColor"
                          key={i}
                        >
                          <h1 className="text-2xl font-bold px-3 py-1">
                            {item.kelompok}
                          </h1>
                          <div className="flex flex-row justify-between px-6 pt-4 pb-4 border-y border-thirdColor">
                            <div>
                              <h2>
                                Ketua:{" "}
                          ...
                          <div className="flex flex-row justify-between">
                            ...
                            <div className="w-1/3 text-center py-2 rounded-ee-lg text-white bg-thirdColor hover:bg-thirdColor/80">
                              <button
                                onClick={() => {
                                  router.push({
                                    ...
                                    query: {
                                      ...
                                      id: item.id,
                                      telp: item.telpon,
                                      jenis_kelompok: item.jenis_kelompok,
                                    },
                                  });
                                }}
                              >
